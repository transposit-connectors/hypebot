(params) => {
  ...
  return _.flatten(api.runBulk(params.sentence.replace(/\b(it|in|an|on|in|a|the|from|to|with|of|and|but|so|for|are|is|be|being|was|that|this)\b/g, "").split(/[ \/,:;.?!<>]+/).map(s => {
    return {
